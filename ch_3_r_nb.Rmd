...
```{r 3_1_load_packages, warning = FALSE}
library(mlbench)
...
glass_saman <- bind_rows("Fyrir" = glass_cs_tidy, "Eftir" = glass_yj_tidy, .id = "nafn")

glass_saman %>% 
  ggplot(mapping = aes(x = gildi, color = nafn, fill = nafn)) +
